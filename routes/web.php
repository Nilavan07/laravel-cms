...
Route::prefix('console')
     ->middleware('auth')
     ->group(function() {
    Route::get   ('certificates/list',[CertificatesController::class, 'list']);
    Route::get   ('certificates/add',[CertificatesController::class, 'addForm']);
    Route::post  ('certificates/add',[CertificatesController::class, 'add']);
    Route::get   ('certificates/edit/{certificate}',[CertificatesController::class, 'editForm']) ->where('certificate','[0-9]+');
    Route::post  ('certificates/edit/{certificate}',[CertificatesController::class, 'edit']) ->where('certificate','[0-9]+');
    Route::get   ('certificates/delete/{certificate}',[CertificatesController::class, 'delete']) ->where('certificate','[0-9]+');
    Route::get   ('certificates/image/{certificate}', [CertificatesController::class, 'imageForm']) ->where('certificate','[0-9]+');
    Route::post  ('certificates/image/{certificate}', [CertificatesController::class, 'image'])->where('certificate','[0-9]+');
});
