...
<section class="w3-padding">
    ...
    <form method="POST"
          action="/console/certificates/edit/{{ $certificate->id }}"
      ...
      <div class="w3-margin-bottom">
        ...
        <input type="date" name="date_awarded"
               value="{{ old('date_awarded', $certificate->date_awarded->toDateString()) }}"
               class="w3-input w3-border" required>
      ...
      <div class="w3-margin-bottom">
        ...
        <textarea name="description" rows="3"
                  class="w3-input w3-border">{{ old('description', $certificate->description) }}</textarea>
